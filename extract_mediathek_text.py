...
def extract_from_xmlfile(filename, filename_out):    with open(filename) as infile:        text = infile.read()
    if text.startswith('<!DOCTYPE html>'):        print(filename,'is a html file.')
